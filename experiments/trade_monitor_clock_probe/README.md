...
- 不修改正式 `trade_monitor_bridge.py` 與 `trade_monitor_resume_guard.py`。
...
```powershell
python experiments/trade_monitor_clock_probe/clock_probe.py snapshot
```
...
```powershell
python experiments/trade_monitor_clock_probe/clock_probe.py verify
```
...
```powershell
python experiments/trade_monitor_clock_probe/clock_probe.py observe --cycles 10 --align-second 5
```
...
```powershell
python experiments/trade_monitor_clock_probe/clock_probe.py codex-dry-run --image <chart.png>
```
...
```powershell
python experiments/trade_monitor_clock_probe/clock_probe.py codex-dry-run --image <chart.png> --execute
```
...
```powershell
python experiments/trade_monitor_clock_probe/clock_probe.py structured-dry-run `
  --image <chart.png> `
