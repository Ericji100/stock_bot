...
本報告必須從強勢族群中找出可能的市場故事，不得只做漲跌排行。請在既有章節中補上：

1. 族群強勢背後可能的故事：技術、籌碼、營收、新聞、產業、趨勢、題材各面向有哪些線索。
2. 資金輪動推演：哪些族群可能主升、補漲、退潮或由次族群接棒。
3. 爆發條件：量價放大、法人續買、營收轉強、產業催化或題材擴散。
4. 待驗證訊號：哪些只是 price-only、新聞情緒或資料不足。
5. 失敗條件：過熱、法人反手、營收反證、題材退燒或族群輪動結束。
