"""Deterministic objective-state primitives for hybrid monitoring protocol V2.
...
ENGINE_VERSION = "hybrid-v3-objective-state-v2"
ENGINE_STATUS = "FINAL"
...
def derive_objective_state(
    *,
    ...
    if pivot_definition != PIVOT_DEFINITION:
        raise ValueError(f"official V2 baseline only accepts {PIVOT_DEFINITION}")
