"""Freeze the R3 execution manifest for one-pass structural-role alignment."""
...
MANIFEST_VERSION = "v2-core-legacy-role-alignment-execution-r3-candidate"
OUTPUT_FILE = "legacy_role_alignment_execution_manifest_candidate_r3.json"
...
def build_manifest(artifact_dir: Path) -> dict[str, Any]:
    files = {
        ...
        "failure_analysis": artifact_dir / "FAILURE_ANALYSIS_legacy_anchor_alignment_r2.md",
        ...
        "prompt": artifact_dir / "v2_core_legacy_role_alignment.prompt.candidate_r3.md",
        "schema": artifact_dir / "v2_core_legacy_role_alignment.schema.candidate_r3.json",
        "runner": ROOT / "scripts" / "v2_core_legacy_role_alignment_runner_v3.py",
        "validator": ROOT / "scripts" / "v2_core_legacy_role_alignment_validator_v3.py",
        "comparator": ROOT / "scripts" / "v2_core_legacy_role_alignment_compare_v3.py",
    ...
    manifest = {
        ...
        "run_directory": "legacy_role_alignment_runs_candidate_r3",
