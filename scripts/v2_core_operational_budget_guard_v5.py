"""Dispatch v8 through the latest 70% operational usage guard."""
...
from scripts import v2_core_operational_budget_guard_v4 as previous


GUARD_VERSION = "v2-core-operational-budget-guard-r5"
EXPECTED_MANIFEST_VERSION = "v2-core-m2a-triplicate-execution-r8-candidate"
EXPECTED_POLICY_VERSION = "v2-core-operational-budget-override-v6"
...
def _latest_contract() -> Iterator[None]:
    inherited = previous.previous.previous
    saved_previous = {
        ...
        "EXPECTED_THRESHOLD": previous.EXPECTED_THRESHOLD,
        "EXPECTED_RUNNERS": previous.EXPECTED_RUNNERS,
    }
    saved_inherited = {"EXPECTED_THRESHOLD": inherited.EXPECTED_THRESHOLD}
    ...
    previous.EXPECTED_THRESHOLD = EXPECTED_THRESHOLD
