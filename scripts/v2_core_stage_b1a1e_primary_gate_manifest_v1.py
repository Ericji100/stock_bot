"""Build the immutable execution manifest for B1a1E R4."""
...
OUTPUT_FILE = "stage_b1a1e_primary_gate_execution_manifest_candidate_r4.json"
OUTPUT_MD = "stage_b1a1e_primary_gate_execution_manifest_candidate_r4.md"


def build_manifest(artifact_dir: Path = ARTIFACT_DIR) -> dict:
    input_manifest = generate_all(artifact_dir)
    bindings = {
        "input_manifest_file": "stage_b1a1e_primary_gate_input_manifest_candidate_r4.json",
        ...
        "gate_file": "B1A1E_PRIMARY_GATE_CANDIDATE_R4.md",
        "operational_policy_file": "operational_budget_override_v11.json",
    }
    manifest = {
        "manifest_version": "v2-core-stage-b1a1e-primary-gate-execution-r4-candidate",
        "status": "READY_FOR_FORMAL_AI_FRESH_PILOT（可執行正式AI全新試跑）",
        ...
        "run_directory": "stage_b1a1e_primary_gate_runs_candidate_r4",
