"""Freeze the fifth fresh R4 upstream validation execution manifest."""
...
OUTPUT = "stage_b1a1e_primary_gate_validation4_execution_manifest_r1.json"


def generate(artifact_dir: Path = ARTIFACT_DIR):
    source = generate_all(artifact_dir)
    files = {
        "input_manifest_file": "stage_b1a1e_primary_gate_validation4_input_manifest_r1.json",
        ...
        "gate_file": "B1A1E_PRIMARY_GATE_FRESH_VALIDATION_R4.md",
        "operational_policy_file": "operational_budget_override_v13.json",
    }
    manifest = {
        "manifest_version": "v2-core-stage-b1a1e-primary-gate-fresh-validation-r4",
        ...
        "run_directory": "stage_b1a1e_primary_gate_validation4_runs_r1",
        "input_packet_directory": source["input_packet_directory"],
        "program_gate_directory": source["program_gate_directory"],
        ...
        "rows": [
            {
                ...
                for key in (
                    ...
                    "directional_evidence_option_count",
                    "objective_contact_candidate_count",
                )
            }
