"""Freeze the B1a2 active-link R2 calibration execution manifest."""
...
OUTPUT_FILE="stage_b1a2_active_link_execution_manifest_candidate_r2.json"
...
SCHEMA_FILE="v2_core_stage_b1a2_active_link.schema.candidate_r2.json"
DESIGN_FILE="B1A2_ACTIVE_CAMPAIGN_LINK_CANDIDATE_R2.md"
...
RUN_DIRECTORY="stage_b1a2_active_link_runs_candidate_r2"

def generate(artifact_dir: Path=ARTIFACT_DIR)->dict:
    source=generate_all(artifact_dir)
    if source["case_count"]!=5: raise ValueError("R2 requires four calibration cases plus one regression case")
