"""Freeze the B1b2 control-relevance calibration execution manifest."""
...
OUTPUT = "stage_b1b2_control_relevance_execution_manifest_candidate_r1.json"


def generate(artifact_dir: Path = ARTIFACT_DIR) -> dict:
    source = generate_all(artifact_dir)
    files = {
        "input_manifest_file": "stage_b1b2_control_relevance_input_manifest_candidate_r1.json",
        "prompt_file": "v2_core_stage_b1b2_control_relevance.prompt.candidate_r1.md",
        "schema_file": "v2_core_stage_b1b2_control_relevance.schema.candidate_r1.json",
        "design_file": "B1B2_CURRENT_CONTROL_RELEVANCE_PROBE_R1.md",
    ...
    manifest = {
        "manifest_version": "v2-core-stage-b1b2-control-relevance-calibration-r1-candidate",
        ...
        "run_directory": "stage_b1b2_control_relevance_runs_candidate_r1",
        ...
        "program_derives_relevance_pool": True,
