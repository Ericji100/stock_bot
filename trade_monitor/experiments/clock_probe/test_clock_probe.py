...
from trade_monitor.experiments.clock_probe.clock_probe import (
...
from trade_monitor.experiments.clock_probe.message_renderer import (
...
def test_snapshot_and_verify_do_not_modify_source(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import trade_monitor.experiments.clock_probe.clock_probe as module
